...
const Index = ()=> {
  ...
  <img src="https://www.hubnex.in/companyicon/ontimedelivery.svg" className="card-img" />
  ...
  <Ri24HoursLine className='text-4xl mb-3'/>
    <h5 className="card-title">Escrow account keeping your <br /> money safe</h5>
    <p className="card-text"> Lorem ipsum dolor sit amet consectetur.</p>
  </div>
</div>  {/* BLOCK 3 SECOND CARD ENDS */}
     </div> 
